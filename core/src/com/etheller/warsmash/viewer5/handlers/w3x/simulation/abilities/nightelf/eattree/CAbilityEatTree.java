...
public class CAbilityEatTree extends CAbilityTargetSpellBase {
	...
	public void populateData(final GameObject worldEditorAbility, final int level) {
		ripDelay = worldEditorAbility.getFieldAsFloat(AbilityFields.DATA + DataFieldLetter.A + level, 0);
		eatDelay = worldEditorAbility.getFieldAsFloat(AbilityFields.DATA + DataFieldLetter.B + level, 0);
		hitPointsGained = worldEditorAbility.getFieldAsFloat(AbilityFields.DATA + DataFieldLetter.C + level, 0);
