...
public class CAbilityItemFigurineSummon extends CAbilityNoTargetSpellBase {
	...
	public void populateData(final GameObject worldEditorAbility, final int level) {
		final String unitTypeOne = worldEditorAbility.getFieldAsString(AbilityFields.DATA + DataFieldLetter.C + level, 0);
		...
		final String unitTypeTwo = worldEditorAbility.getFieldAsString(AbilityFields.DATA + DataFieldLetter.D + level, 0);
